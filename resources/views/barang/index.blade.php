          ...
          <div class="col-12">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <a href="{{route('/barang/tambah-data')}}" class="btn btn-primary">Tambah Data</a>
                    </div>
                        ...
                        <table id="table-barang" class="table table-bordered table-hover">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>{{$d['stok']}}</td>
                                <td>
                                    <a href="{{url('/barang/edit', $d->id)}}" class="btn btn-secondary">Edit</a>
                                    <form action="{{url('/barang/delete', $d->id)}}" method="post" class="d-inline border-0">
                                        @method('delete')
                                        @csrf
